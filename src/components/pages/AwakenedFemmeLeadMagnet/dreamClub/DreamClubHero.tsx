    ...
    >
      <section className="max-w-[900px] mx-auto py-20">
        ...
        <motion.h1 
          ...
          viewport={{ once: true }}
          className="text-4xl text-[#E5B5A7] uppercase tracking-[4px] leading-[54px] mb-8"
        >
        ...
        >
          ...
          >
            <CTAButton 
              ...
              className="w-full bg-[#E5B5A7] text-black rounded-full px-8 py-4 font-medium tracking-wider uppercase hover:bg-white transition-all duration-300" 
            />
          </motion.div>
        </motion.div>
