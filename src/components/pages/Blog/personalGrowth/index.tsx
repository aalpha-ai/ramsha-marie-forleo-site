...
export const PersonalGrowthArticle: React.FC = () => {
  return (
    <div className="flex flex-col items-center bg-[#FFF5F5]">
      <div className="flex flex-col md:flex-row justify-between px-6 md:px-14 py-16 w-full max-w-[1400px] gap-8">
        ...
        <div className="flex flex-col max-w-[600px]">
          ...
          <div className="flex gap-6 mt-4 mb-8">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs tracking-widest uppercase">Video</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs tracking-widest uppercase">Audio</span>
            </div>
          </div>
        ...
        <div className="relative flex-1">
          <img
            ...
            alt="Seth Godin speaking at an event"
