    ...
    <div className="text-xl flex flex-col items-center">
      <div className="flex flex-col items-center px-14 pt-20 pb-20 w-full max-md:px-5 max-md:max-w-full">
        <div className="flex flex-col pt-12 pb-6 max-w-full tracking-normal leading-8 text-black w-[850px]">
          <motion.div 
            className="font-logo w-full text-5xl tracking-wider leading-[62.4px] text-neutral-800 max-md:max-w-full"
            initial={{ opacity: 1 }}
            viewport={{ once: true }}
          >
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <div className="w-full max-md:max-w-full font-logo text-5xl">
