...
const milestoneData = [
  {
    imageSrc: "/ramsha-pics/webp/gfshoot9.webp",
  ...
  {
    imageSrc: "/ramsha-pics/webp/gf5924.webp",
  ...
  {
    imageSrc: "/ramsha-pics/webp/gf06171OMGLOOK.webp",
    ...
    <div className="flex flex-col items-center">
      <div className="flex flex-col items-center px-14 pt-20 pb-20 w-full max-md:px-5 max-md:max-w-full">
        <div className="flex flex-col pt-12 pb-6 max-w-full tracking-normal leading-8 text-black w-[850px]">
          <motion.div 
            className="font-header w-full text-[30px] lg:text-4xl tracking-tight leading-[62.4px] text-neutral-800 max-md:max-w-full"
            initial={{ opacity: 1 }}
            viewport={{ once: true }}
          >
