...
const DreamClubSection: React.FC<DreamClubSectionProps> = () => {
  const sections = [
    {
      title: "Mid-Year Reset: The Uncommon Practice That Will Help You Turn 2024 Into Your Best Year Yet!",
      subtitle: "(Plus, a bonus Dream Club Kick-Off Party!)",
      content: "January is long gone. Discover why resetting your goals in JUNE is the secret weapon to catapult your success! Grab your gel pens — I'm taking you behind the scenes of my personal process to help you clarify what you want, simplify where you're going, and amplify your money, freedom, and happiness.",
      additionalInfo: "Includes a celebratory kick-off party and Ask Me Anything jam session!",
      testimonial: "I feel more alive than I have in 5 years. I feel like I'm reconnecting to my body and strengthening my connection to my soul and prioritizing my joy. THANK YOU.",
    ...
    {
      title: "The Automated Lead Machine That Saves Us $10,000/mo, Generates 5K + Leads — with an 80% CTR 🤯!",
      content: "In this behind-the-scenes walkthrough, we'll show you the secret automation tool that brings us thousands of new leads a month… while we sleep. This done-with-you workshop can put leads on autopilot and save you TENS of thousands of dollars. This one workshop alone is worth 10X the investment in Dream Club.",
      testimonial: "I just closed my biggest deal yet!!! Got a little baby project as well too, but this big one is such a win!!",
    ...
    {
      title: "Millionaire Marketing Throwdown: The Dead Simple Email and Text Campaign That Generated $1,112,055 — Overnight!",
      content: "What if you could make more money than most businesses do all year — starting with one email or text? I've tapped a certain marketing legend (and personal friend) to walk you through his emotionally genius campaign that makes millions… for those who know how to do it right. Join us for an epic marketing throwdown and real-time work session that has the power to turn your cash flow into a friggin' tsunami.",
      testimonial: "I'm stepping onto a global stage! Only 12 Enneagram experts are selected each year for this monthly live session. My goal this year is to stop hiding my light under a bushel. I'm ready to share my vision as my overarching goal is to help families end generational trauma for generations to come!",
    ...
    {
      title: "Strategic Planning Workshop With Marie & Her VP Of Operations: How to Hit Big Revenue Goals, Grow Your Business, and STILL Take Months Off — Using Our One-Page Secret Weapon",
      content: "I'm going to let you in on a secret…🤫 There are a lot of Big Names who appear cool, calm, and collected. But, behind the curtain — they're stressed out, overstretched, and constantly putting out fires. That's not what running a freedom-rich business is about. In this exclusive workshop, my VP of Operations and I will share our proprietary curveball-proof planning strategy. In one hour, you'll walk away with a clear path to more success and peace-of-mind.",
      testimonial: "I CAN LEARN business stuff! I am finishing up the process of opening my store on TPT and Etsy… with quirky and whimsical designs and I'm DOING IT!! Biggest lesson: anything is figureoutable.",
      testimonialAuthor: "Kaci B.",
      imageSrc: "https://cdn.builder.io/api/v1/image/assets/48a1608e30b648c89bd5ed134a49b3b8/d90791a43158f4d20f7885087198d888ff201f42d05d18bd652d26b61f1d4dc4?apiKey=48a1608e30b648c89bd5ed134a49b3b8&",
  ...
  return (
    <section className="flex flex-col items-center bg-stone-50">
      <div className="flex flex-col px-14 pt-20 pb-20 w-full max-md:px-5 max-md:max-w-full">
        <SectionHeading />
