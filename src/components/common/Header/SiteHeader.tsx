...
export function SiteHeader() {
   ...
   return (
      <>
         <header className="animate-fade-in fixed left-0 top-0 z-50 w-full -translate-y-4 border-b opacity-0 backdrop-blur-md [--animation-delay:600ms] bg-black text-white">
         ...
         <AnimatePresence>
            <motion.nav
               ...
               className={cn(
                  `bg-black/70 fixed left-0 top-0 z-50 h-screen w-full overflow-auto backdrop-blur-md text-white`,
                  {
