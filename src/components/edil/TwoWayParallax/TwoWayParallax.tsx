...
import TwoWayParallaxCarousel from "@/components/edil/TwoWayParallax/TwoWayParallaxCarousel";

const TwoWayParallax: React.FC = () => {
  const images = [
  ...
  return (
    <div className="relative w-full bg-gray-100 dark:bg-gray-700">
      <div className="h-48"></div>
        <TwoWayParallaxCarousel images={images} />
      <div className="h-48"></div>
    </div>
  );
};
